    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &NeslihanBase::velCallback, this);
}

void NeslihanBase::velCallback(const neslihan_msgs::Velocities& vel)
{
